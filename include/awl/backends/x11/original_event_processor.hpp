#ifndef AWL_BACKENDS_X11_ORIGINAL_EVENT_PROCESSOR_HPP_INCLUDED
#define AWL_BACKENDS_X11_ORIGINAL_EVENT_PROCESSOR_HPP_INCLUDED
...
:
	public awl::backends::x11::event_processor
{
	FCPPT_NONCOPYABLE(
