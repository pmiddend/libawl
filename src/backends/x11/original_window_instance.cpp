...
awl::backends::x11::original_window_instance::original_window_instance(
...
void
awl::backends::x11::original_window_instance::show()
{
	// always returns 1
	::XMapWindow(
		display_->get(),
...
awl::backends::x11::original_window_instance::size() const
{
	Window root_return;
...
awl::backends::x11::original_window_instance::display() const
{
	return display_;
}

int
awl::backends::x11::original_window_instance::screen() const
{
	return screen_;
}

awl::backends::x11::visual_ptr const
awl::backends::x11::original_window_instance::visual() const
{
	return visual_;
}

Window
awl::backends::x11::original_window_instance::get() const
{
	return window_;
}
